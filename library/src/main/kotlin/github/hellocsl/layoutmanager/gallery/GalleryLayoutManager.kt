...
class GalleryLayoutManager(val orientation: Int = GalleryLayoutManager.HORIZONTAL) :
    ...
    private fun calculateToCenterFraction(child: View, pendingOffset: Float): Float {
        ...
        val childLength = if (orientation == GalleryLayoutManager.HORIZONTAL) child.getWidth() else child.getHeight()
        ...
        override fun onScrolled(recyclerView: RecyclerView?, dx: Int, dy: Int) {
            ...
            if (snap != null) {
                ...
                if (selectedPosition != currentSelectedPosition) {
                    ...
                    mOnItemSelectedListener?.apply { onItemSelected(recyclerView, snap, currentSelectedPosition) }
                }
            }
            if (BuildConfig.DEBUG) {
